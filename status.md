...
--------------------------------------------------------------
  Gold                     304     769 kr   233,642 kr  21.3%
  Silver                     -     518 kr         0 kr   0.0%
  Eli Lilly                 14  11,627 kr   162,782 kr  14.8%
  Walmart                    -   1,085 kr         0 kr   0.0%
  Cameco                     -     868 kr         0 kr   0.0%
  Vertiv                     -   2,792 kr         0 kr   0.0%
  Broadcom                  80   3,721 kr   297,667 kr  27.2%
  Howmet Aerospace           -   2,796 kr         0 kr   0.0%
  Spiltan Räntefond          -     manual   371,551 kr  33.9%
  War Chest                  -     manual         0 kr   0.0%
  Reactor Core Cash          -     manual    30,621 kr   2.8%
--------------------------------------------------------------
  TPV                                        1,096,263 kr
    Reactor Core            724,712 kr  (66%)
...
==============================================================
  ...
  Projected @ AWAR        :     9,029,297 kr
  vs target               :    -3,905,409 kr  (deficit)

  Scenario         CAGR       Projected     FI date   (incl. 6,000 kr/mo contributions)
  ------------------------------------------------------------------------
  Bear           +10%       4,523,917 kr       ~2047
  Conservative   +15%       6,973,420 kr       ~2041
  Base           +20%      10,666,603 kr       ~2038
  Current AWAR   +18%       9,029,297 kr       ~2039
  Bull           +30%      24,222,414 kr       ~2035
...
==============================================================
  ...
  Breakeven               2.21%   MID
  HY OAS                279 bps   TIGHT
  IG Credit               1.59%   TIGHT
  Curve 10Y-3M          +69 bps   MID
...
==============================================================
  ...
  Eli Lilly      14.8%   HIGH  HIGH     -0.2%     -0.2%   46%   149  
  Walmart         0.0%    LOW   LOW     +0.2%     +0.2%   53%    60  
  Cameco          0.0%    LOW   LOW     +2.0%     +2.0%   67%    82  
  Vertiv          0.0%    LOW   LOW     +2.1%     +2.1%   58%    65  
  Broadcom       27.2%    MID   LOW     +0.3%     +0.3%   54%    41  
...
==============================================================
  ...
  Silver GSR Tactical
    GSR now        : 69.49  (as of 2026-07-27)
    60d GSR peak   : 71.56
  ...
  AVGO 200d Guard
    AVGO now       : $383.22  (as of 2026-07-27)
    200d SMA       : $364.07  (+5.3% gap)
    5d ROC         : +1.3%  (crash threshold: -10%)
    Signal         : BASE  (trigger: none)
    LLY stress     : inactive  ($1197.53 vs 200d SMA $1015.72, 5d ROC +4.4%)
...
==============================================================
  ...
  Next kr        -> Broadcom (AVGO)
    Current wt (of Reactor Core) : 41.1%
...
==============================================================
  Regime check (2026-07-27): RY=HIGH  BAA=TIGHT  -- no confirmed flip (window=3d)
Building regime labels ...
  Conditions    : {'ry_regime': 'HIGH', 'baa10y_regime': 'TIGHT'}
  Matched dates : 1401  (2004-05-07 - 2026-07-27)  MODERATE
